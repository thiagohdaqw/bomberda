(define (problem bomberdaproblem)
        ...
        (:objects x1 x2 x3 x4 x5 y1 y2 y3 y4 y5 y6 y7 - position
                    ...
                    t0 t1 t2 t3 - timer)
        (:init 
            (wall x1 y1) (wall x2 y1) (wall x3 y1) (wall x4 y1) (wall x5 y1) (wall x1 y2) (wall x5 y2) (wall x1 y3) (wall x5 y3) (wall x1 y4) (wall x4 y4) (wall x5 y4) (wall x1 y5) (wall x5 y5) (wall x1 y6) (wall x5 y6) (wall x1 y7) (wall x2 y7) (wall x3 y7) (wall x4 y7) (wall x5 y7)
            ...
            (at bomberman x2 y6)
            (at enemy x4 y2) (is-enemy enemy) (has-enemy)
